...
router.post(
  ...
  [
    ...
    body('perKmRate').optional().isFloat({ min: 0 }).withMessage('perKmRate must be a non-negative number'),
    body('minimumDistanceKm').optional().isFloat({ min: 0 }).withMessage('minimumDistanceKm must be a non-negative number'),
    body('perStopCharge').optional().isFloat({ min: 0 }).withMessage('perStopCharge must be a non-negative number'),
