...
const tripsAdminRoutes    = require('./modules/trips/trips.admin.routes');
...
const faqsAdminRoutes     = require('./modules/faqs/faqs.admin.routes');
const instructionsRoutes  = require('./modules/instructions/instructions.routes');
const instructionsAdminRoutes = require('./modules/instructions/instructions.admin.routes');
const servicesRoutes      = require('./modules/services/services.admin.routes');
...
app.use(`${API}/admin/trips`,   tripsAdminRoutes);
...
app.use(`${API}/admin/faqs`,     faqsAdminRoutes);
app.use(`${API}/instructions`,   instructionsRoutes);
app.use(`${API}/admin/instructions`, instructionsAdminRoutes);
